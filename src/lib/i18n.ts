  ...
  fr: {
    translation: {
      ...
      pages: {
        ...
        inscription: {
          title: "Inscription",
          successTitle: "Inscription Réussie / تم التسجيل بنجاح",
          successSub: "Veuillez conserver vos codes QR ci-dessous / يرجى الاحتفاظ برموز QR الخاصة بك أدناه.",
          formSub: "Merci de remplir ce formulaire avec soin. Toutes les informations sont obligatoires et utilisées dans le cadre du Job Day IFIAG.",
          fullName: "👤 Nom complet / الاسم الكامل *",
          fullNameHint: "(Merci d’écrire Prénom + Nom / المرجو كتابة الاسم الكامل)",
          email: "📧 Adresse e-mail / البريد الإلكتروني *",
          emailHint: "(Utilisée pour la confirmation et l’envoi de l’invitation / للتأكيد وإرسال الدعوة)",
          phone: "📱 Numéro de téléphone / رقم الهاتف *",
          phoneHint: "(WhatsApp de préférence / يفضل رقم واتساب)",
          domain: "🎓 Domaine de formation / مجال التكوين *",
          level: "📘 Niveau d’études / المستوى الدراسي *",
          cv: "📎 CV / السيرة الذاتية *",
          cvHint: "Téléversement obligatoire du CV. Formats : PDF, IMAGE. Taille max : 2 Mo. (المرجو رفع السيرة الذاتية)",
          upload: "Cliquez pour uploader / انقر للتحميل",
          submit: "Envoyer ma demande / إرسال طلبي",
          qrAccess: "QR Code d’accès au Job Day IFIAG",
          qrCv: "QR Code lié à votre CV (Recruteurs)",
          qrAccessDesc: "Présentez ce code lors de l'accueil pour un accès rapide.",
          qrCvDesc: "Ce code sera consultable par les recruteurs partenaires.",
          print: "Imprimer / طباعة",
          download: "Télécharger / تحميل",
          new: "Nouvelle inscription / تسجيل جديد",
          validated: "Inscription validée ! / تم تأكيد التسجيل",
          error: "Une erreur est survenue / حدث خطأ ما",
          cvRequired: "Veuillez joindre votre CV / يرجى إرفاق سيرتك الذاتية",
          domains: {
            it: "Technologies de l’Information (IT) / تكنولوجيا المعلومات",
            rh: "Ressources Humaines (RH) / الموارد البشرية",
            management: "Gestion & Management / التسيير والتدبير",
            marketing: "Marketing & Communication / التسويق والتواصل",
            finance: "Finance & Comptabilité / المالية والمحاسبة",
            autre: "Autre / آخر"
          },
          levels: {
            bac: "Bac / بكالوريا",
            bac2: "Bac+2 / سنتين بعد البكالوريا",
            bac3: "Bac+3 / إجازة",
            bac5: "Bac+5 et plus / ماستر فما فوق"
          },
          info: {
            confirmationTitle: "✅ Confirmation & accès à l’événement",
            confirmationText: "Après validation de votre inscription, vous recevrez un e-mail de confirmation et deux QR Codes personnels : un pour l'accès et un lié à votre CV. Ils seront utilisés le jour J pour un accès sans papier.",
            whyTitle: "🌟 Pourquoi participer au Job Day IFIAG ?",
            points: [
              "Accéder à des stages adaptés à votre profil",
              "Valoriser votre CV auprès de recruteurs partenaires",
              "Bénéficier d’un processus de sélection structuré",
              "Vivre une expérience professionnelle, digitale et innovante"
            ]
          }
        },
        insertion: {
  ...
  ar: {
    translation: {
      ...
      pages: {
        ...
        inscription: {
          title: "التسجيل",
          successTitle: "تم التسجيل بنجاح / Inscription Réussie",
          successSub: "يرجى الاحتفاظ برموز QR الخاصة بك أدناه / Veuillez conserver vos codes QR.",
          formSub: "المرجو ملء هذه الاستمارة بعناية. جميع المعلومات مطلوبة وتستخدم في إطار Job Day IFIAG.",
          fullName: "👤 الاسم الكامل / Nom complet *",
          fullNameHint: "(المرجو كتابة الاسم العائلي + الشخصي / Merci d’écrire Prénom + Nom)",
          email: "📧 البريد الإلكتروني / Adresse e-mail *",
          emailHint: "(يستخدم للتأكيد وإرسال الدعوة / Utilisée pour la confirmation)",
          phone: "📱 رقم الهاتف / Numéro de téléphone *",
          phoneHint: "(يفضل رقم واتساب / WhatsApp de préférence)",
          domain: "🎓 مجال التكوين / Domaine de formation *",
          level: "📘 المستوى الدراسي / Niveau d’études *",
          cv: "📎 السيرة الذاتية / CV *",
          cvHint: "رفع السيرة الذاتية إجباري. الصيغ المقبولة: PDF, IMAGE. الحجم الأقصى: 2 ميغا. (Téléversement obligatoire du CV)",
          upload: "انقر للتحميل / Cliquez pour uploader",
          submit: "إرسال طلبي / Envoyer ma demande",
          qrAccess: "رمز الدخول إلى Job Day IFIAG",
          qrCv: "رمز السيرة الذاتية الخاص بك (للمشغلين)",
          qrAccessDesc: "قدم هذا الرمز عند الاستقبال لدخول سريع.",
          qrCvDesc: "سيكون هذا المركز قابلاً للاطلاع من قبل المشغلين الشركاء.",
          print: "طباعة / Imprimer",
          download: "تحميل / Télécharger",
          new: "تسجيل جديد / Nouvelle inscription",
          validated: "تم تأكيد التسجيل! / Inscription validée",
          error: "حدث خطأ ما / Une erreur est survenue",
          cvRequired: "يرجى إرفاق سيرتك الذاتية / CV requis",
          domains: {
            it: "تكنولوجيا المعلومات (IT) / Technologies de l’Information",
            rh: "الموارد البشرية (RH) / Ressources Humaines",
            management: "التسيير والتدبير / Gestion & Management",
            marketing: "التسويق والتواصل / Marketing & Communication",
            finance: "المالية والمحاسبة / Finance & Comptabilité",
            autre: "آخر / Autre"
          },
          levels: {
            bac: "بكالوريا / Bac",
            bac2: "سنتين بعد البكالوريا / Bac+2",
            bac3: "إجازة / Bac+3",
            bac5: "ماستر فما فوق / Bac+5 et plus"
          },
          info: {
            confirmationTitle: "✅ التأكيد والدخول إلى الحدث",
            confirmationText: "بعد تأكيد تسجيلك، ستتلقى بريدًا إلكترونيًا ورمزي QR شخصيين: واحد للدخول والآخر مرتبط بسيرتك الذاتية. سيتم استخدامهما يوم الحدث لدخول سريع وحديث.",
            whyTitle: "🌟 لماذا المشاركة في Job Day IFIAG؟",
            points: [
              "الوصول إلى تدريبات مناسبة لملفك الشخصي",
              "إبراز سيرتك الذاتية لدى المشغلين الشركاء",
              "الاستفادة من عملية اختيار منظمة",
              "عيش تجربة مهنية ورقمية ومبتكرة"
            ]
          }
        },
        insertion: {
